...
class Post
{
    private static $post_motivasi = [
        [
            "judul"=>"Motivasi 1",
            "slug"=>"motivasi-1",
            "deskripsi"=>"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Pariatur esse cumque est reiciendis numquam sint, quam totam fugiat odio aspernatur ratione at aut voluptates! Rerum nam adipisci quis repellendus esse neque laborum, harum inventore eaque quisquam est ullam. Maiores tempore voluptatibus ex doloremque cumque. Aperiam sed dolorum perspiciatis neque vero fugit. Voluptatem explicabo sunt error odit eum neque, iusto, accusamus necessitatibus repudiandae dolor, minima ullam delectus? Nostrum sit dignissimos error assumenda, facere laboriosam, commodi quibusdam ducimus ea non, quae rem?"
        ],
        [
            "judul"=>"Motivasi 2",
            "slug"=>"motivasi-2",
